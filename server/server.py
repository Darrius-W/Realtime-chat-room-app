...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('postgresql://chatroomapp_db_user:WMLMQVyUxXQCLyijRbHvFvPGTR6k5pCU@dpg-crscqrjtq21c73de7bd0-a.oregon-postgres.render.com/chatroomapp_db')
